...
import { block, build, color, draw, drawflush, item, liquid, operation, packColor, print, printflush, read, variable } from "../generator/core"
...
const text = switchValue(i, ["Slag", "Arkycite", "Water", "Battery", "Ozone"]).get()
...
sto.mul(100).floor().div(100)
cap.mul(100).floor().div(100)
print(text+": "+"["+stoA+"/"+capA+"] "+sto+"/"+cap+"\n")
